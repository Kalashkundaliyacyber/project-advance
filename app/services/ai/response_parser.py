"""
ThreatWeave AI — Response Parser
...
logger = logging.getLogger("threatweave.response_parser")
...
def _parse_json(text: str) -> Any:
    ...
    try:
        ...
        logger.warning("_parse_json strategy 1 (direct) failed: %s", exc)
    ...
    if m:
        try:
            ...
            logger.warning("_parse_json strategy 2 (extract block) failed: %s", exc)
    ...
    try:
        ...
        logger.warning("_parse_json strategy 3 (trailing-comma fix) failed: %s", exc)
