 ...
 */
  ...
  function _restoreRichWidget(tokenType, data, frag) {
    try {
      switch (tokenType) {
        ...
        case 'LIVE_VULN_TABLE_START': _buildLiveVulnTableEl(data, frag); break;
  ...
  function _showProjectOnboarding(greeting) {
    ...
    d.innerHTML = `
      ...
      <div class="ob-welcome" id="${uid}-welcome" style="opacity:0">
        Welcome back to <span class="ob-brand">ThreatWeave</span> —<br>
    ...
    confirm.innerHTML = `
      <div class="pi-header">
        ...
        <div>
          ...
          <div class="pi-sub">Workspace ready · ThreatWeave is standing by</div>
        </div>
      </div>
    `;
  ...
  function _submitScanIP(uid) {
    ...
    // Remove the prompt card and auto-start vuln scan immediately
